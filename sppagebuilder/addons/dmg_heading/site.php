...
class SppagebuilderAddonDmg_heading extends SppagebuilderAddons
{
    ...
    public function render()
    {
        ...
        if (isset($settings->alignment_responsive) && $settings->alignment_responsive == 1) {
            if (isset($settings->alignment) && $settings->alignment) {
                preg_match('/(sppb-text-)(left|right|center)/i', $settings->alignment, $matches);
                $class .= ' text-' . $matches[2];
                unset($matches);
            }
            $class .= (isset($settings->alignment_responsive_lg) && $settings->alignment_responsive_lg) ? ' ' . $settings->alignment_responsive_lg : ' text-lg-center';
            $class .= (isset($settings->alignment_responsive_sm) && $settings->alignment_responsive_sm) ? ' ' . $settings->alignment_responsive_sm : ' text-md-center';
            $class .= (isset($settings->alignment_responsive_sm) && $settings->alignment_responsive_sm) ? ' ' . $settings->alignment_responsive_sm : ' text-sm-center';
        } else {
